...
public class DBConnection {
    ...
    private static boolean createTables() {
        try {
            ...
            statement.executeUpdate("INSERT INTO lagomorphs(name, species, age, move, sleep, eat, vetAction, sound, color, food, male, weight, numberOfMeals, locationXInCage, locationYInCage) VALUES('Nagini', 'Snake', 120, 'Move like animal', 'Sleep like animal', 'Eat Harry Potter', '', 'SSsss', 'Brown', 'Meat', 0, 35, 1, 4, 4)");
            statement.executeUpdate("INSERT INTO lagomorphs(name, species, age, move, sleep, eat, vetAction, sound, color, food, male, weight, numberOfMeals, locationXInCage, locationYInCage) VALUES('Boa', 'Snake', 100, 'Move like snake', 'Sleep like snake', 'Eat mouse', '', 'Ssss', 'Brown', 'Animal', 1, 50, 2, 4, 1)");
            statement.executeUpdate("INSERT INTO reptiles(name, species, age, move, sleep, eat, vetAction, sound, color, food, male, weight, numberOfMeals, locationXInCage, locationYInCage) VALUES('Tuptuś', 'Rabbit', 2, 'kic kic', 'Sleep like animal', 'Om om Carrot', '', 'RABIT XD', 'Gray', 'CARROT', 1, 4, 50, 3, 3)");
            statement.executeUpdate("INSERT INTO reptiles(name, species, age, move, sleep, eat, vetAction, sound, color, food, male, weight, numberOfMeals, locationXInCage, locationYInCage) VALUES('Rabbitos', 'Rabbit', 5, 'kic kic', 'Sleep like rabbit', 'Hrup hrup', '', '', 'Brown', 'CARROT', 0, 2, 40, 3, 1)");
